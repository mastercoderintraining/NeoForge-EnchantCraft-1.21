package net.codercadet.enchantcraft.block;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<net.minecraft.world.level.block.Block> ENCHANTED_ORE = registerBlock("enchanted_ore",
